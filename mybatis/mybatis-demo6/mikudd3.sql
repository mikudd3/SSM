...
-- ----------------------------
BEGIN;
INSERT INTO `card` VALUES ('1001', '令狐冲', '北京大学', '1'), ('1002', '岳林山', '北京大学', '2'), ('1003', '李四', '清华大学', '3'), ('1004', '张三', '清华大学', '4'), ('1005', '郭靖', '复旦大学', '5'), ('1006', '黄蓉', '复旦大学', '6'), ('1007', '武松', '交通大学', '7'), ('1008', '西门庆', '交通大学', '8');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `course` VALUES ('1', '1', 'Java程序设计', '5'), ('2', '1', 'C语言', '5'), ('3', '2', '高等数学（一）', '8'), ('4', '2', '高等数学（二）', '8'), ('5', '3', '大学物理', '6'), ('6', '4', '化学原理', '8');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `score` VALUES ('1', '1', '99.00'), ('1', '2', '90.00'), ('2', '1', '100.00'), ('2', '2', '89.00'), ('3', '6', '88.00'), ('4', '6', '60.00'), ('5', '5', '70.00'), ('6', '5', '80.00'), ('7', '3', '100.00'), ('7', '4', '99.00'), ('8', '3', '90.00'), ('8', '4', '78.00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `student` VALUES ('1', '令狐冲', '1001', '计算机', '2021-08-23 15:04:31', '男', '20'), ('2', '岳林山', '1001', '计算机', '2021-07-23 15:04:31', '女', '18'), ('3', '李四', '1002', '化学', '2021-06-23 15:04:31', '女', '18'), ('4', '张三', '1002', '化学', '2021-06-23 15:04:31', '男', '18'), ('5', '郭靖', '1003', '物理', '2021-09-23 15:04:31', '男', '23'), ('6', '黄蓉', '1003', '物理', '2021-09-23 15:04:31', '女', '23'), ('7', '武松', '1004', '数学', '2021-10-23 15:04:31', '男', '20'), ('8', '西门庆', '1004', '数学', '2021-06-23 15:04:31', '男', '16');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `teacher` VALUES ('1', '黄药师', '电子工程系'), ('2', '乔峰', '化学系'), ('3', '老顽童', '数学系'), ('4', '小蓝', '物理系');
COMMIT;
